# This file will be created by the user during Phase 1.
# It will contain the RAG Engine logic.
import os, shutil
...
# Custom prompt to force the LLM to use the PDF context
...
def ingest_pdf(file_path):
    # 🚨 CLEAN SLATE: Clear old memory before indexing new PDF
...
def get_chat_response(query, use_cloud=False):
    if not os.path.exists(DB_DIR):
        return "Please upload a PDF first so I can help you!"
